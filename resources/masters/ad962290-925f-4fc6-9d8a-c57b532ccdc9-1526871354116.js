jQuery("#simulation")
  .on("click", ".m-ad962290-925f-4fc6-9d8a-c57b532ccdc9 .click", function(event, data) {
    ...
    if(jFirer.is("#m-ad962290-light_Icon_5")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#m-ad962290-logo_3")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#m-ad962290-logo_4")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#m-ad962290-logo_2")) {
      cases = [
        {
          "blocks": [
            {
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#m-ad962290-Button_12")) {
      cases = [
        {
          "blocks": [
            {
                  ...
                  "parameter": [ {
                    "#m-ad962290-925f-4fc6-9d8a-c57b532ccdc9 #m-ad962290-ID > .backgroundLayer": {
                      "attributes": {
                        ...
                        "border-top-color": "#EFEFC8",
                        "border-right-width": "3px",
                        "border-right-style": "solid",
                        "border-right-color": "#EFEFC8",
                        "border-bottom-width": "3px",
                        "border-bottom-style": "solid",
                        "border-bottom-color": "#EFEFC8",
                        "border-left-width": "3px",
                        "border-left-style": "solid",
                        "border-left-color": "#EFEFC8",
  ...
  .on("pageload", ".m-ad962290-925f-4fc6-9d8a-c57b532ccdc9 .pageload", function(event, data) {
    ...
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#m-ad962290-Text_31")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("mouseenter dragenter", ".m-ad962290-925f-4fc6-9d8a-c57b532ccdc9 .mouseenter", function(event, data) {
    ...
    if(jFirer.is("#m-ad962290-light_Icon_5") && jFirer.has(event.relatedTarget).length === 0) {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#m-ad962290-Button_12") && jFirer.has(event.relatedTarget).length === 0) {
      event.backupState = true;
      event.target = jFirer;
      cases = [
        {
