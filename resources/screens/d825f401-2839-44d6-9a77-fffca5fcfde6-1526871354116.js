jQuery("#simulation")
  ...
  .on("mouseenter dragenter", ".s-d825f401-2839-44d6-9a77-fffca5fcfde6 .mouseenter", function(event, data) {
    ...
    if(jFirer.is("#s-Fav_Icon") && jFirer.has(event.relatedTarget).length === 0) {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Product_Image_Default") && jFirer.has(event.relatedTarget).length === 0) {
      event.backupState = true;
      event.target = jFirer;
      cases = [
        {
      ...
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-Click_ZOOM") && jFirer.has(event.relatedTarget).length === 0) {
      event.backupState = true;
      event.target = jFirer;
      cases = [
        {
